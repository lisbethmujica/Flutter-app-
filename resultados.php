...
<br>
  ...
  <div class="examenes">
      <h1>¡Sube los Resultados. Aqui!</h1>
      <br>
      <br>
      <center>
      <form action="upload_resultado.php" enctype="multipart/form-data" method="post">
    
      <input type="file" id="archivo[]" name="archivo[]" multiple required>
            
            </label>
            <br><br>
              <input type="submit" value="Subir Examen" name="submit">
      </center>
</form>
  </div>
  </html>
