...
<div class="formulario">
    ...
    <form action="cambiar_contrasena.php" method="POST">
        ...
        <input type="text" name="id_codigo" placeholder="Código" required><br><br>
        <input type="password" name="id_nuevacontrasena" placeholder="Nueva contraseña" required><br><br>
